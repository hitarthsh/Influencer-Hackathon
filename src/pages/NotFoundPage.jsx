...
const NotFoundPage = ({ setPage }) => {
  useEffect(() => {
    ...
    // MorphSVG animations (requires MorphSVGPlugin)
    if (gsap.utils.toArray && MorphSVGPlugin) {
  ...
  return (
    <div className="relative min-h-screen flex flex-col items-center justify-center pt-10 sm:pt-16 bg-[#00E7DC] overflow-hidden">
      <div className="absolute inset-0 w-full h-full bg-[#00E7DC] -z-10" />
      <div className="w-full flex flex-col items-center justify-center z-10">
        <h1
          className="text-3xl sm:text-5xl lg:text-6xl font-black mb-4 sm:mb-8 text-center text-white font-nunito opacity-0 animate-fade-in-down px-2 sm:px-0"
          id="notfound-title"
        >
          Page not found.
        </h1>
        <div className="w-full flex justify-center mb-6 sm:mb-8">
          {/* SVG Illustration */}
          <div className="w-full h-64 sm:h-96 md:h-[500px] lg:h-[700px] relative">
            <svg
        ...
        <button
          ...
          className="mt-2 sm:mt-4 bg-blue-500 text-white py-2 px-6 rounded shadow hover:bg-blue-700 transition-all text-base sm:text-lg z-20"
        >
          Back to Home
        </button>
      </div>
